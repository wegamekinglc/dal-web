---
name: dal-web
description: Work on the DAL web UI and backend. Use when starting or stopping the FastAPI/React app, changing code in this repo, running backend/frontend/e2e tests, applying the industrial terminal UI style, or enforcing async backend rules.
---
...
Use this skill for tasks in this repo: service startup/shutdown, backend FastAPI changes,
